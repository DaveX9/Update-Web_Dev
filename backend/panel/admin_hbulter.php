...
$sql_services = "SELECT * FROM hbulter WHERE section = 'services'";
$result_services = $conn->query($sql_services);
$row_services = $result_services->fetch_assoc();

// Fetch all carousel items
$sql_carousel = "SELECT * FROM hbulter WHERE section LIKE 'carousel%'";
...
<body>
    ...
    <form action="update_hbulter.php" method="POST">
