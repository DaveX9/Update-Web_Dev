...
<div class="container mt-4">
    ...
    <div class="row">
        <?php foreach ($articles as $a): ?>
            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    <a href="article11.php?id=<?= $id ?>">
                        <img src="<?= htmlspecialchars($a['thumbnail']) ?>" class="card-img-top" alt="Thumbnail">
                    </a>
                    <div class="card-body">
                        <h5>
                            <a href="article11.php?id=<?= $id ?>" style="text-decoration: none; color: black;">
                                <?= htmlspecialchars($a['title']) ?>
                            </a>
                        </h5>
                        <p class="category-tag"><?= htmlspecialchars($a['category']) ?> | <?= htmlspecialchars($a['article_date']) ?></p>
                        <a href="<?= $editLink ?>" class="btn btn-primary">Edit</a>
                        <a href="article11.php?id=<?= $id ?>" class="btn btn-secondary">View</a>
