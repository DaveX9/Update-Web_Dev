...
<head>
    ...
    <link rel="stylesheet"
        href="https://cdnjs.cloudflare.com/ajax/libs/froala-editor/4.0.10/css/froala_editor.pkgd.min.css">
        ...
        <form action="save_article.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea name="short_description"
                    class="form-control"><?= htmlspecialchars($article['short_description'] ?? '') ?></textarea>
            </div>

            <div class="mb-3">
                <label>Full Content</label>
                <textarea id="editor"
                    name="full_content"><?= htmlspecialchars_decode($article['full_content'] ?? '') ?></textarea>
            </div>
            <div class="mb-3">
                <label>Tags (comma-separated)</label>
                <input type="text" name="tags" class="form-control" placeholder="e.g. safety, construction, tips"
            ...
            <div class="mb-3">
                ...
                <input type="date" name="article_date" class="form-control"
                    value="<?= $article['article_date'] ?? date('Y-m-d') ?>" required>
            </div>
