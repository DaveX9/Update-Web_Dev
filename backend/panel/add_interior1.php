...
<html>
<head>
    <title><?php echo $id ? 'Edit' : 'Add'; ?> Interior Review</title>
...
<div class="container mt-5">
    <h2><?php echo $id ? 'Edit' : 'Add'; ?> Interior Review</h2>
    <form action="save_interior1.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <?php if (!empty($review['thumbnail'])): ?>
                <img src="/HOMESPECTOR/<?= htmlspecialchars($review['thumbnail']) ?>" style="width: 100px; margin-top: 10px;">
            <?php endif; ?>
        </div>
        ...
        <button type="submit" class="btn btn-success w-100"><?= $id ? 'Update' : 'Save'; ?> Interior Review</button>
    </form>
</div>
