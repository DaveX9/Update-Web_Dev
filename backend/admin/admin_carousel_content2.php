...
.button-container .cancel-btn:hover {
    ...
    <?php
        ...
        $featured_title = isset($featured_data['title']) ? $featured_data['title'] : "สุดพิเศษ! พาดูบ้านหรู";
        $featured_description = isset($featured_data['description']) ? $featured_data['description'] : " รีวิวตรวจบ้านหรู 40ล้าน! CEO #บุญนําพา'";
