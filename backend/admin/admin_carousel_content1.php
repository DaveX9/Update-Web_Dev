...
.button-container .cancel-btn:hover {
    ...
    <?php
        ...
        $featured_title = isset($featured_data['title']) ? $featured_data['title'] : "ต.ตรวจบ้าน x การตลาดวันละตอน";
        $featured_description = isset($featured_data['description']) ? $featured_data['description'] : "พาดูบ้านหรู 89 ล้าน! แกรนด์ บางกอก บูเลอวาร์ด ยาร์ด บางนา'";
        $featured_image = isset($featured_data['image']) ? $featured_data['image'] : "/HOMESPECTOR/img/carousel_thumb1.jpg";
    ?>
