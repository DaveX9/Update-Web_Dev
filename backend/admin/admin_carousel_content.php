...
.button-container .cancel-btn:hover {
    ...
    <?php
        ...
        $featured_title = isset($featured_data['title']) ? $featured_data['title'] : "รีวิวตรวจบ้านดารา เซเลบ อินฟลู";
        $featured_description = isset($featured_data['description']) ? $featured_data['description'] : "รีวิวการตรวจบ้านเดี่ยว พระเอกดัง!! 'ตงตง เดอะสตาร์'";
        $featured_image = isset($featured_data['image']) ? $featured_data['image'] : "/HOMESPECTOR/img/thumbnail4.jpg";
    ?>
        ...
        <form id="admin-form" enctype="multipart/form-data">
            ...
            <div id="episode-container">
                ...
                $default_episodes = [
                    ...
                    ["title" => "บ้านดาราเซเลบ อินฟลู", "image" => "/HOMESPECTOR/img/thumbnail2.jpg"],
                    ["title" => "ประกันภัยบ้าน แฮปปี้โฮม", "image" => "/HOMESPECTOR/img/thumbnail3.jpg"]
                ];
