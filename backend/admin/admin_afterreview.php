    ...
    <form id="review-form" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea id="review-description" name="review_description" rows="4">
                รีวิวจากทีมงานมืออาชีพของ ต.ตรวจบ้าน พาเจาะลึกโครงการบ้านชื่อใหม่ในแบบบ้านใหม่...
            </textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <img src="/HOMESPECTOR/img/landhouse2.jpg" alt="Review Image" class="preview-image">
