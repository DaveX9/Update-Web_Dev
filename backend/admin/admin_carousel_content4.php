...
.button-container .cancel-btn:hover {
    ...
    <?php
        ...
        $featured_title = isset($featured_data['title']) ? $featured_data['title'] : "ประกันภัยบ้าน แฮปปี้โฮม ธนชาต";
        $featured_description = isset($featured_data['description']) ? $featured_data['description'] : " ช่วงนี้หน้าฝน อย่ามองข้ามสิ่งนี้🏡⛈️'";
        $featured_image = isset($featured_data['image']) ? $featured_data['image'] : "/HOMESPECTOR/img/thumbnail1.jpg";
    ?>
