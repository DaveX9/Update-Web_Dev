...
.button-container .cancel-btn:hover {
    ...
    <?php
        ...
        $featured_title = isset($featured_data['title']) ? $featured_data['title'] : "ตรวจบ้านก่อนโอน by ต.ตรวจบ้าน";
        $featured_description = isset($featured_data['description']) ? $featured_data['description'] : " ตรวจบ้านก่อนโอน by ต.ตรวจบ้าน......'";
        $featured_image = isset($featured_data['image']) ? $featured_data['image'] : "/HOMESPECTOR/img/carousel_thumb2.jpg";
    ?>
