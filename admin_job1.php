...
<div class="container">
    ...
    <form id="edit-form">
        <textarea id="froala-editor" name="content"><?php echo htmlspecialchars_decode($job_section); ?></textarea>
        <br>
        <button type="submit">Save Changes</button>
        <div id="success-message" class="success-message">Content updated successfully!</div> <!-- Placed below button -->
    </form>
</div>
