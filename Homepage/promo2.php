                ...
                <!-- <div class="service-container">
                    ...
                    <div class="service-list">
                        <div class="service-item">
                            <img src="/HOMESPECTOR/icon/ICON/offer.png" alt="Discount 1">
                            <div class="service-text">
                                <h3>รับฟรี ส่วนลดพิเศษ</h3>
                                <p>สำหรับทำบุญขึ้นบ้านกับบุญนำพา มูลค่า 2,000 บาท</p>
                            </div>
                        </div>
                        <div class="service-item">
                            <img src="/HOMESPECTOR/icon/ICON/contact-us.png" alt="Discount 2">
                            <div class="service-text">
                                <h3>ติดต่อรับสิทธิ์</h3>
                                <p>ได้ที่ไลน์ @boonumpar *แจ้งชื่อโครงการและบ้านเลขที่พร้อมคูปองฉบับนี้</p>
                            </div>
                        </div>
                        <div class="service-item">
                            ...
                            <div class="service-text">
                                ...
                                <p>ส่วนลดพิเศษนี้สามารถใช้ได้ทันที ไม่มีขั้นต่ำ</p>
                            </div>
                        </div>
                    </div>
                </div>
