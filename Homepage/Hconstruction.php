...
$sql_services = "SELECT content FROM hconstruction WHERE section = 'services'";
$result_services = $conn->query($sql_services);
$row_services = $result_services->fetch_assoc();

// Fetch carousel content
$sql_carousel = "SELECT content FROM hconstruction WHERE section = 'carousel'";
        ...
        <div class="content-box">
            ...
            <section class="services-container">
                ...
                <div class="service-banner">
                    <img src="/HOMESPECTOR/img/construction-bg.jpg" alt="Service Banner">
                </div>
                <div class="service-cards">
                    <div class="service-card">
                        <img src="/HOMESPECTOR/img/s3.png" alt="Mobile Development Icon"
                            onclick="window.location.href='/HOMESPECTOR/Homepage/Hconstruction.php'">
                ...
                <div class="service-container">
                    ...
                    <div class="image-container">
                        <div class="image-box">
                            ...
                            <img src="/HOMESPECTOR/img/Hconstruction-bg.jpg" alt="Construction Services">
                        </div>
                        <div class="call-box">
                    ...
                    <div class="text-container">
                        <h2 class="main-title">ต.ต่อเติม รับเหมาต่อเติมบ้าน</h2>
                        <p class="description">
                            บริการรับเหมาต่อเติมบ้าน ครบวงจร งานตกแต่ง รีโนเวทบ้านเดิม ให้เหมือนใหม่ รวมไปถึง
                            งานหลังคา งานปูกระเบื้อง ผนังเบา และงานระบบไฟฟ้า ประปา และอื่นๆ
                        </p>
