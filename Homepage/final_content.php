...
<head>
  ...
  <link rel="stylesheet" href="/HOMESPECTOR/CSS/after_content.css">
    ...
    <section class="content">
      <div class="content-container">
        ...
        <div class="video-header">
          <h1>เปิดพอร์ตความสุขของ "ดร.นิเวศน์ เหมวชิรวรากร"</h1>
        </div>
        ...
        <div class="video-section">
          ...
          <div class="featured-video">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/InvmM9gkKfI?si=kcHWt0_84e4NHCri"
              title="YouTube video player" frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
              referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            <h2>ต.ตรวจบ้าน x การตลาดวันละตอน EP.1 </h2>
            <p>พาดูคฤหาสน์หรู 50 ล้าน! grand GrandBangkokBoulevardPinklaoBorom ปิ่นเกล้า-บรมฯ | ต.ตรวจบ้าน x
              การตลาดวันละตอน EP.1</p>
          </div>
          ...
          <div class="related-videos">
            ...
            <div class="related-videos-container">
              ...
              <div class="related-video-item">
                <a href="/HOMESPECTOR/Homepage/final_content.php" target="_blank" class="video-link">
                  <img src="/HOMESPECTOR/img/thumbnail1.jpg" alt="Video Thumbnail">
                  <h3>Mindset ที่จะเปลี่ยนชีวิตคุณ | EP.28</h3>
                </a>
              </div>
              <div class="related-video-item">
                <a href="/HOMESPECTOR/Homepage/final_content.php" target="_blank" class="video-link">
              ...
              <div class="related-video-item">
                <a href="/HOMESPECTOR/Homepage/final_content.php" target="_blank" class="video-link">
                  <img src="/HOMESPECTOR/img/thumbnail2.jpg" alt="Video Thumbnail">
                  <h3>Mindset ที่จะเปลี่ยนชีวิตคุณ | EP.28</h3>
                </a>
              </div>
              ...
              <div class="related-video-item">
                <a href="/HOMESPECTOR/Homepage/final_content.php" target="_blank" class="video-link">
                  <img src="/HOMESPECTOR/img/thumbnail3.jpg" alt="Video Thumbnail">
                  <h3>Mindset ที่จะเปลี่ยนชีวิตคุณ | EP.28</h3>
                </a>
              </div>
          ...
          <div class="tags-section">
            ...
            <div class="tags">
              ...
              <a href="#" class="tag"
                data-tag="GrandBangkokBoulevardPinklaoBoroma">GrandBangkokBoulevardPinklaoBorom</a>
    ...
    <section class="carousel-content">
      ...
      <div class="content-carousel-container">
        ...
        <div class="content-carousel">
          ...
          <!-- Item 5 -->
          <a href="/HOMESPECTOR/Homepage/carousel_content.php" class="content-carousel-item">
            <img src="/HOMESPECTOR/img/thumbnail1.jpg" alt="Content 5">
            <div class="content-carousel-info">
