...
<body>
    <div class="content-box">
        ...
        <div class="contact-container">
            <a href="tel:02-454-2043" class="contact-item">
                <div class="icon">
                    <i class="fa-solid fa-phone"></i>
                </div>
                <span>โทร 02-454-2043</span>
            </a>
            <a href="https://line.me/R/ti/p/@t.home" target="_blank" class="contact-item">
                <div class="icon">
        ...
        <div class="carousel_content">
            <section class="main-content">
                ...
                <div class="left-image">
                    ...
                    <div class="left-content">
                        <h1><?= htmlspecialchars($main['title']) ?></h1>
                        <p class="main-description"><?= htmlspecialchars($main['description']) ?></p>
                        <div class="social-share">
                            <span>SHARE :</span>
                            <a href="https://www.facebook.com/t.homeinspector/?locale=th_TH">
                                <img src="/HOMESPECTOR/icon/ICON/Fb.png" alt="Facebook">
                ...
                <div class="episodes-list">
                    ...
                    <div class="episode">
                        ...
                        <iframe src="<?= htmlspecialchars($ep['youtube_url']) ?>" title="<?= htmlspecialchars($ep['title']) ?>" allowfullscreen></iframe>
                        </div>
                        <div class="episode-info">
        ...
        <?php
            ...
            // Fetch main section
            $main = $pdo->query("SELECT * FROM carousel_main_content4 WHERE id = 1")->fetch();

            // Fetch all episodes
            $episodes = $pdo->query("SELECT * FROM carousel_episodes4 ORDER BY created_at DESC")->fetchAll();
        ?>
        <div class="carousel_content">
            <section class="main-content">
                <!-- Left Side: Main Content -->
        ...
        <?php
            ...
            // Fetch main section
            $main = $pdo->query("SELECT * FROM carousel_main_content5 WHERE id = 1")->fetch();

            // Fetch all episodes
            $episodes = $pdo->query("SELECT * FROM carousel_episodes5 ORDER BY created_at DESC")->fetchAll();
        ?>
        <div class="carousel_content">
            <section class="main-content">
                <!-- Left Side: Main Content -->
