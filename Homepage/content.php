...
<head>
  ...
  <link rel="stylesheet" href="/HOMESPECTOR/CSS/content.css">
  ...
  <div class="content-box">
    ...
    <div class="Content">
      ...
      <!-- <div class="categories">
        ...
        <button class="category-btn" data-category="Price">Price</button>
        <button class="category-btn" data-category="Process">Process</button>
        <button class="category-btn" data-category="Interior">Interior</button>
      </div> -->
      ...
      <!-- Content Cards -->
      <div class="content-cards" id="content-container"></div>


      <script>
        fetch("/HOMESPECTOR/backend/panel/api_admin_content.php")
          .then(res => res.json())
          .then(({ categories, contents }) => {
            const container = document.getElementById("content-container");
            const categoryButtons = document.getElementById("category-buttons");

            // 1. Create filter buttons
            const allBtn = `<button class="category-btn active" data-category="all">All</button>`;
            const catBtns = categories.map(cat =>
              `<button class="category-btn" data-category="${cat.name}">${cat.name}</button>`
            ).join('');
            categoryButtons.innerHTML = allBtn + catBtns;

            // 2. Render dynamic cards (add after static ones)
        ...
        `;
            ...
            // 3. Filter both static & dynamic cards
            categoryButtons.addEventListener('click', e => {
              if (e.target.classList.contains('category-btn')) {
                ...
                cards.forEach(card => {
                  ...
                  card.style.display = (selectedCat === "all" || cardCat === selectedCat) ? "block" : "none";
                });
              }
            });
          });
      ...
      <div class="content-cards" id="content-container">
        <a href="/HOMESPECTOR/Homepage/carousel_content.php" class="card" data-category="Roof">
          <img src="/HOMESPECTOR/img/thumbnail4.jpg" alt="content 1">
          <h5>รีวิวตรวจบ้านดารา เซเลบ อินฟลู</h5>
        </a>
        <a href="/HOMESPECTOR/Homepage/carousel_content1.php" class="card" data-category=">Price">
          <img src="/HOMESPECTOR/img/carousel_thumb1.jpg" alt="content 2">
          <h5>ต.ตรวจบ้าน x การตลาดวันละตอน</h5>

        </a>
        <a href="/HOMESPECTOR/Homepage/carousel_content2.php" class="card" data-category="Price">
          <img src="/HOMESPECTOR/img/thumbnail3.jpg" alt="Hcontent 3">
          <h5>สุดพิเศษ! พาดูบ้านหรู</h5>
        </a>
        <a href="/HOMESPECTOR/Homepage/carousel_content3.php" class="card" data-category="Price">
          <img src="/HOMESPECTOR/img/carousel_thumb2.jpg" alt="Hcontent 4">
          <h5>ตรวจบ้านก่อนโอน by ต.ตรวจบ้าน</h5>

        </a>
        <a href="/HOMESPECTOR/Homepage/carousel_content4.php" class="card" data-category="Process">
          <img src="/HOMESPECTOR/img/warentty.jpg" alt="House Review 5">
          <h5>ประกันภัยบ้าน แฮปปี้โฮม ธนชาต</h5>
        </a>
        <a href="/HOMESPECTOR/Homepage/carousel_content5.php" class="card" data-category="Interior">
